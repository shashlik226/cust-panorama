...
var PlayMenu = ( function()
{
		...
		else
		{
			...
			if( m_gameModeSetting == 'survival' && ( !PartyListAPI.IsPartySessionActive() || PartyListAPI.GetCount() <= 1 ) && m_serverSetting == 'listen' ) {
				...
				UiToolkitAPI.ShowGenericPopupOk(
					'Warning',
					'You can\'t launch this mode in solo',
					'',
					function () { },
					function () { } );
				return;
	...
	function _UpdateOrCreateMapGroupTile( mapGroupName, container, elTilePanel, newTileID )
	{
		...
		else
		{
			...
			var iconPath = mapGroupName === 'random_classic' ? 'file://{images}/icons/ui/random.svg' : 'file://{images}/' + mg.icon_image_path + '.svg';
		...
		if ( mapGroupName === 'random_classic' )
		{
			...
			mapImage.style.backgroundImage = 'url("file://{images}/map_icons/screenshots/1080p/default.png")';
