...
function InitScenePanel()
{
    ...
    playerPanel.SetSceneAngles( 0, 0, 0, 0 );
...
function InitSceneWithContextsPanel()
{
    ...
    playerPanel.ResetAnimation( false );
    playerPanel.SetSceneAngles( 0, 11.5, 0, 0 );
    ...
    playerPanel.SetSceneAngles( 0, 13, 0, 0 );
    ...
    playerPanel.SetSceneAngles( 0, -9.5, 0, 0 );
    ...
    playerPanel.SetSceneAngles( 0, -183.5, 0, 0 );
