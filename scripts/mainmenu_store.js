...
var MainMenuStore = ( function()
{
	...
	var _Init = function()
	{
		...
		if ( tournamentId !== 0 )
		{
			m_elStore.SetDialogVariable( "tournament_name", $.Localize( "#CSGO_Tournament_Event_Location_" + tournamentId ) );
			itemsByCategory.tournament = _OperationTournamentSetupObj( tournamentId );
		}
	...
	var _OperationTournamentSetupObj = function(tournamentId)
	{
		var tournament = [
			{
				...
				{
					elpanel.Data().tournamentId = tournamentId;
